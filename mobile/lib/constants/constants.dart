class Constants {
  ...
  static const String errorMessageNewPassword = 'Invalid password';
  static const String errorMessageConfirmPassword =
      'The confirmation password does not match the new password.';
  static const String createNewPassword = 'Create new password';
  static const String textInstruction =
      'Please enter your new password and make sure your password is 8-32 characters with at least one uppercase, lowercase, number, and special character.';
  static const String goodNews =
      "Good news! You are just few steps away to login to MOVE. Click on the button below to login.";
  static const String verificationFailed = "Verification failed";
  static const String yourAccountVerificationHasExpired =
      "Your account verification has expired. Please verify your account again to enjoy full access on MOVE.";
  ...
  static const String priceUSD = 'Prices are shown in USD';
  ...
  static const String saveMyPayment =
      'Save my payment details for faster checkout in the future.';
  ...
  static const String pleaseAllowPopUP =
      'Please allow pop-up windows access in Safari to continue with your payment. To allow pop-up windows in Safari, open the ';
  static const String appAndSelect = ' app and select ';
  static const String safari = 'Safari';
  static const String finallyTurnOn = 'Finally, turn on the toggle on ';
  static const String blockPopUps = 'Block Pop-ups';
  ...
  static const String defaultThumbnailImage = 'https://move-project.s3.us-east-1.amazonaws.com/images/defa0650-8b8a-11ef-b9dd-b39040cf0f3e.jpeg';
