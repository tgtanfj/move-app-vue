...
function ne(a2, t, e, n = {}) {
  ...
  const C = (h2) => i ? typeof i == "function" ? i(h2) : hi(h2) : h2, _ = () => ti(a2[t]) ? C(a2[t]) : p, D = (h2) => {
  ...
  if (u) {
    ...
    return watch(
      () => a2[t],
      (B) => {
        P2 || (P2 = true, E.value = C(B), nextTick(() => P2 = false));
      }
    ), watch(
      E,
      (B) => {
...
function Bt(a2, t, e, n = {}) {
  ...
  d && a2.preventDefault();
  let E = null;
  return D || _ ? E = Rl(h2, t, {
    goForward: _ ? g : u === "ltr" ? p : f,
    loop: i
  }) : m2 ? E = h2.at(0) || null : C && (E = h2.at(-1) || null), c && (E == null || E.focus()), E;
}
...
var yv = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, { dir: l, disabled: s } = toRefs(e), r = be(l), { modelValue: i, changeModelValue: u, isSingle: d } = Nl(e, n), { forwardRef: c, currentElement: p } = R2();
    return Ui({
      disabled: s,
      direction: r,
...
function Kl(a2, t) {
  ...
  return watchEffect((s) => {
    if (!qe)
      return;
    const r = async (i) => {
      t != null && t.value && (await nextTick(), !(!t.value || Ll(t.value, i.target)) && i.target && !n.value && Kt(
        Ji,
        a2,
        { originalEvent: i }
      ));
...
function Gl(a2) {
  ...
  const r = (m2 = "month", C) => {
    ...
    if (C || a2.nextPage.value) {
      const h2 = $u(_, C || a2.nextPage.value);
    ...
    if (C || a2.prevPage.value) {
      const h2 = Bu(_, C || a2.prevPage.value);
  ...
  }, c = computed(() => n.value.length ? n.value[0].rows[0].map((m2) => t.dayOfWeek($(m2), a2.weekdayFormat.value)) : []), p = (m2 = "month", C) => {
    const _ = n.value[0].value;
    if (C || a2.nextPage.value) {
  ...
  const v2 = computed(() => {
    ...
    const m2 = $(n.value[0].value), C = $(n.value[n.value.length - 1].value), _ = t.fullMonth(m2, e.value), D = t.fullMonth(C, e.value), h2 = t.fullYear(m2, e.value), E = t.fullYear(C, e.value);
...
var ku = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, {
      ...
      prevPage: B,
      dir: T
    } = toRefs(e), { primitiveElement: M, currentElement: V2 } = ke(), A2 = be(T), F = ne(e, "modelValue", n, {
    ...
    return onMounted(() => {
      ...
      default: withCtx(() => [
        ...
        createBaseVNode("div", Ru, [
          createBaseVNode("div", Au, toDisplayString(unref(N2)), 1)
        ])
      ]),
      _: 3
...
var Dt = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    ]), { floatingStyles: C, placement: _, isPositioned: D, middlewareData: h2 } = useFloating(
      l.anchor,
      i,
      {
        strategy: "fixed",
    ...
    return ed({
      ...
      return openBlock(), createElementBlock("div", {
        ...
        style: normalizeStyle({
          ...unref(C),
          transform: unref(D) ? unref(C).transform : "translate(0, -200%)",
...
var Fv = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    async function f(N2) {
      var G2, L;
      c.value = N2, await nextTick(), N2 ? (d.value && (Array.isArray(d.value) && l.value ? p.value = (G2 = h2().find((z2) => {
        var Y, K;
    ...
    const g = ref(false), m2 = ref(), C = ref(), { forwardRef: _, currentElement: D } = R2(), { getItems: h2, reactiveItems: E, itemMapSize: P2 } = ba("data-radix-vue-combobox-item"), B = ref([]);
    watch(() => P2.value, () => {
    ...
    const V2 = computed(() => T.value.findIndex((N2) => Ye(N2, p.value))), A2 = computed(() => {
      var N2;
    ...
    }), watch(() => [T.value.length, u.value.length], async ([N2, G2], [L, z2]) => {
      await nextTick(), await nextTick(), N2 && (z2 > G2 || V2.value === -1) && (p.value = T.value[0]);
    });
    const U = Je(D);
    function W2() {
    ...
    return sd({
      ...
      onInputNavigation: async (N2) => {
        const G2 = V2.value;
        G2 === 0 && N2 === "up" || G2 === T.value.length - 1 && N2 === "down" || (G2 === -1 && T.value.length || N2 === "home" ? p.value = T.value[0] : N2 === "end" ? p.value = T.value[T.value.length - 1] : p.value = T.value[N2 === "up" ? G2 - 1 : G2 + 1], W2(), ee(), nextTick(() => {
          var L;
    ...
    }), (N2, G2) => (openBlock(), createBlock(unref(Tt), null, {
      default: withCtx(() => [
        createVNode(unref(O), mergeProps({
          ref: unref(_),
          style: {
...
var qv = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    return pd({
      isSelected: i
    }), (m2, C) => (openBlock(), createBlock(unref(Zt), { value: m2.value }, {
      default: withCtx(() => [
...
var Ot = defineComponent({
  ...
  setup(a2, { expose: t, emit: e }) {
    ...
    }), (C, _) => (openBlock(), createBlock(unref(Ca), null, {
      default: withCtx(() => [
        createVNode(unref(O), {
...
var so = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    Gn(), ha(i.value);
    const d = ref(""), c = ref(0), p = ref(0), f = ref(null), v2 = ref("right"), g = ref(0), m2 = ref(null), { createCollection: C } = Me(), { forwardRef: _, currentElement: D } = R2(), h2 = C(D);
    watch(D, (A2) => {
      ...
      default: withCtx(() => [
        createVNode(so, mergeProps(unref(l), {
          ...
          onKeydown: p[4] || (p[4] = (f) => {
            ...
            v2 && g && (unref(s).onOpenChange(false), (C = unref(i).trigger.value) == null || C.focus(), f.preventDefault());
          })
        }), {
          default: withCtx(() => [
            renderSlot(c.$slots, "default")
...
var go = defineComponent({
  ...
  setup(a2) {
    ...
    async function d(p) {
      ...
      if (f != null && f.width) {
        const m2 = (g = e.content.value) == null ? void 0 : g.dataset.side, C = m2 === "right", _ = C ? -5 : 5, D = f[C ? "left" : "right"], h2 = f[C ? "right" : "left"];
...
var Vd = defineComponent({
  ...
  emits: ["update:modelValue", "update:placeholder"],
  setup(a2, { expose: t, emit: e }) {
    const n = a2, l = e, { locale: s, disabled: r, readonly: i, isDateUnavailable: u, granularity: d, defaultValue: c, dir: p } = toRefs(n), f = Un(n.locale), v2 = be(p), { primitiveElement: g, currentElement: m2 } = ke(), C = ref(/* @__PURE__ */ new Set());
    onMounted(() => {
    ...
    }), B = ls(E.value), T = ref(_.value ? { ...Nt({ value: _.value, formatter: f }) } : { ...B }), M = computed(() => In({
      granularity: E.value,
      dateRef: h2.value,
      formatter: f,
    ...
    const F = ref(null), U = computed(() => Array.from(C.value).findIndex((z2) => {
      var Y;
...
var Dm = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    }), (L, z2) => (openBlock(), createBlock(unref(ms), {
      open: unref(N2),
...
var Gm = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    }), (G2, L) => (openBlock(), createBlock(unref(ms), {
      open: unref(ee),
...
var ec = defineComponent({
  ...
  setup(a2, { expose: t, emit: e }) {
    ...
    const N2 = ref(null), G2 = computed(() => Array.from(v2.value).findIndex((X) => {
      var se, pe;
...
var yh = defineComponent({
  ...
  setup(a2, { expose: t, emit: e }) {
    const n = a2, l = e, {
      ...
      passive: n.modelValue === void 0
    }), { primitiveElement: T, currentElement: M } = ke(), V2 = Je(M), A2 = computed(() => typeof d.value == "string" ? { edit: d.value, preview: d.value } : d.value), F = ref(B.value);
    function U() {
    ...
    const G2 = zl(() => N2(), M), L = Kl(() => N2(), M), z2 = computed(() => B.value === "");
    return t({
...
var Sh = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    return lc({
      ...
      triggerElement: f
    }), (C, _) => (openBlock(), createBlock(unref(Tt), null, {
      default: withCtx(() => [
        renderSlot(C.$slots, "default", { open: unref(r) })
      ]),
      _: 3
    }));
  }
...
var Ih = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, { multiple: l, highlightOnHover: s, orientation: r, disabled: i, selectionBehavior: u, dir: d } = toRefs(e), { getItems: c } = ba(), { handleTypeaheadSearch: p } = ga(), { primitiveElement: f, currentElement: v2 } = ke(), g = Qe(), m2 = be(d), C = Je(v2), _ = ref(), D = ref(false), h2 = ref(true), E = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue ?? (l.value ? [] : void 0),
      passive: e.modelValue === void 0,
      deep: true
    });
    ...
    return watch(E, () => {
      ...
      default: withCtx(() => [
        ...
        unref(C) && e.name ? (openBlock(), createBlock(unref(to), {
          key: 0,
          name: e.name,
          value: unref(E)
        }, null, 8, ["name", "value"])) : createCommentVNode("", true)
    ...
    this.unsubs = [], this.scrollElement = null, this.targetWindow = null, this.isScrolling = false, this.scrollToIndexTimeoutId = null, this.measurementsCache = [], this.itemSizeCache = /* @__PURE__ */ new Map(), this.pendingMeasuredCacheIndexes = [], this.scrollRect = null, this.scrollOffset = null, this.scrollDirection = null, this.scrollAdjustments = 0, this.elementsCache = /* @__PURE__ */ new Map(), this.observer = /* @__PURE__ */ (() => {
      ...
      ({ count: e, paddingStart: n, scrollMargin: l, getItemKey: s, enabled: r }, i) => {
        ...
        for (let p = d; p < e; p++) {
          ...
          const v2 = s(p), g = this.options.lanes === 1 ? c[p - 1] : this.getFurthestMeasurement(c, p), m2 = g ? g.end + this.options.gap : n + l, C = i.get(v2), _ = typeof C == "number" ? C : this.options.estimateSize(p), D = m2 + _, h2 = g ? g.lane : p % this.options.lanes;
          c[p] = {
            index: p,
            start: m2,
            size: _,
  ...
  setup(a2) {
    ...
    function p(f, v2) {
      ...
      switch (v2) {
        ...
        case "first": {
          C = Et(t.options, n.firstValue.value, (h2 = t.options) == null ? void 0 : h2[0]);
          break;
        }
        case "last": {
    ...
    return n.virtualKeydownHook.on((f) => {
      ...
      if (v2 && f.key === "a" && n.multiple.value ? (f.preventDefault(), n.modelValue.value = [...t.options], m2 = "last") : f.shiftKey && m2 && p(f, m2), ["first", "last"].includes(m2)) {
        ...
        d.value += f.key;
        const _ = Number((C = document.activeElement) == null ? void 0 : C.getAttribute("data-index")), D = c.value[_].textContent, h2 = c.value.map((B) => B.textContent), E = Yn(h2, d.value, D), P2 = c.value.find((B) => B.textContent === E);
  ...
  setup(a2, { emit: t }) {
    ...
    return (p, f) => (openBlock(), createBlock(unref(uo), mergeProps(unref(l), {
      ...
      onFocusOutside: f[1] || (f[1] = (v2) => {
        const g = v2.target;
        unref(u).some((C) => C.contains(g)) && v2.preventDefault();
      }),
...
var ty = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    c(u);
    const { delayDuration: p, skipDelayDuration: f, dir: v2, disableClickTrigger: g, disableHoverTrigger: m2 } = toRefs(e), C = be(v2), _ = $t(false, f), D = computed(() => l.value !== "" || _.value ? 150 : p.value), h2 = Hn((E) => {
...
var ay = defineComponent({
  ...
  setup(a2) {
    ...
    return (m2, C) => (openBlock(), createBlock(unref(O), {
      "as-child": m2.asChild,
      as: m2.as,
      "data-menu-item": "",
...
var dy = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, { disabled: l, min: s, max: r, step: i, locale: u, formatOptions: d, id: c } = toRefs(e), p = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue,
      passive: e.modelValue === void 0
    }), { primitiveElement: f, currentElement: v2 } = ke(), g = Je(v2), m2 = ref(), C = computed(
    ...
    return Vc({
      ...
      id: c
    }), (N2, G2) => (openBlock(), createElementBlock(Fragment, null, [
...
var _y = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    }), (C, _) => (openBlock(), createElementBlock(Fragment, null, [
      createVNode(unref(O), mergeProps(C.$attrs, {
        ref: unref(c),
        dir: unref(p),
        ...
        default: withCtx(() => [
          renderSlot(C.$slots, "default", { modelValue: unref(f) })
        ]),
        _: 3
...
var ip = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, {
      ...
      nextPage: E,
      prevPage: P2
    } = toRefs(e), { primitiveElement: B, currentElement: T } = ke(), M = be(h2), V2 = ref(), A2 = ref(), F = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue ?? { start: void 0, end: void 0 },
      passive: e.modelValue === void 0
    }), U = Ut({
      defaultPlaceholder: e.placeholder,
    ...
    return watch(F, (Ce) => {
      ...
      default: withCtx(() => [
        createBaseVNode("div", lp, [
          createBaseVNode("div", sp, toDisplayString(unref(L)), 1)
        ]),
...
var bp = defineComponent({
  ...
  setup(a2) {
    ...
    }), d = computed(() => e.isSelected(t.day)), c = computed(() => e.isSelectionStart(t.day)), p = computed(() => e.isSelectionEnd(t.day)), f = computed(() => e.isHighlightedStart(t.day)), v2 = computed(() => e.isHighlightedEnd(t.day)), g = computed(() => e.highlightedRange.value ? V(t.day, e.highlightedRange.value.start, e.highlightedRange.value.end) : false), m2 = "[data-radix-vue-calendar-cell-trigger]:not([data-disabled]):not([data-outside-month]):not([data-outside-visible-months])", C = computed(() => $14e0f24ef4ac5c92$export$629b0a497aa65267(t.day, $14e0f24ef4ac5c92$export$aa8b41735afcabd2())), _ = computed(() => !$14e0f24ef4ac5c92$export$a18c89cbd24170ff(t.day, t.month)), D = computed(
...
var Es = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    return Ze(u, C), Ze(l.content, C), (_, D) => (openBlock(), createBlock(unref(O), {
      ref: unref(i),
  ...
  setup(a2) {
    ...
    function u(_, D) {
      if (v2.value) {
        ...
        t.viewport.value.scrollLeft = h2, Jo(h2, D) && _.preventDefault();
      } else {
        const h2 = t.viewport.value.scrollTop + _.deltaY;
        t.viewport.value.scrollTop = h2, Jo(h2, D) && _.preventDefault();
      }
    }
    function d(_, D) {
    ...
    return Ep({
      ...
      onThumbChange: C,
      onDragScroll: g
    }), (_, D) => v2.value ? (openBlock(), createBlock(xp, mergeProps({ key: 0 }, _.$attrs, { ref: unref(n) }), {
      default: withCtx(() => [
        renderSlot(_.$slots, "default")
      ]),
      _: 3
    }, 16)) : (openBlock(), createBlock(Sp, mergeProps({ key: 1 }, _.$attrs, { ref: unref(n) }), {
      default: withCtx(() => [
        renderSlot(_.$slots, "default")
      ]),
      _: 3
...
var Oy = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    const g = Je(r), m2 = ref(/* @__PURE__ */ new Set()), C = computed(() => Array.from(m2.value).map((_) => {
      var D;
    ...
    return Op({
      ...
      default: withCtx(() => [
        ...
        unref(g) ? (openBlock(), createBlock(Tp, mergeProps({ key: C.value }, _.$attrs, {
          "aria-hidden": "true",
          tabindex: "-1",
          required: unref(c),
          name: _.name,
...
var Fp = defineComponent({
  ...
  emits: ["placed"],
  setup(a2, { emit: t }) {
    const e = a2, n = t, { injectCollection: l } = Me(), s = bt(), r = Ct(), i = l(), u = ref(false), d = ref(true), c = ref(), { forwardRef: p, currentElement: f } = R2(), { viewport: v2, selectedItem: g, selectedItemText: m2, focusSelectedItem: C } = r;
    function _() {
...
var Ly = defineComponent({
  ...
  setup(a2) {
    ...
    async function f(m2) {
      var C;
      await nextTick(), !m2.defaultPrevented && (e.value ? (C = l.onItemLeave) == null || C.call(l) : m2.currentTarget.focus({ preventScroll: true }));
    }
    async function v2(m2) {
      var C;
      await nextTick(), !m2.defaultPrevented && m2.currentTarget === document.activeElement && ((C = l.onItemLeave) == null || C.call(l));
    }
    async function g(m2) {
      var _;
      await nextTick(), !(m2.defaultPrevented || ((_ = l.searchRef) == null ? void 0 : _.value) !== "" && m2.key === " ") && (Mp.includes(m2.key) && p(), m2.key === " " && m2.preventDefault());
    }
    if (t.value === "")
      throw new Error(
    ...
    }), (m2, C) => (openBlock(), createBlock(unref(O), {
      ref: unref(s),
      role: "option",
      "data-radix-vue-collection-item": "",
      "aria-labelledby": unref(c),
  ...
  setup(a2, { emit: t }) {
    ...
    return Vs({
      ...
      onStepKeyDown: g[3] || (g[3] = (m2) => {
        const C = p.value ? "from-left" : "from-right", _ = unref(ks)[C].includes(m2.key);
  ...
  setup(a2, { emit: t }) {
    ...
    return Vs({
      ...
      onStepKeyDown: v2[3] || (v2[3] = (g) => {
        const m2 = c.value ? "from-bottom" : "from-top", C = unref(ks)[m2].includes(g.key);
...
var Xy = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    function E() {
      ...
      m2.value[C.value] !== T && n("valueCommit", toRaw(m2.value));
    }
        ...
        default: withCtx(() => [
          (openBlock(), createBlock(resolveDynamicComponent(unref(u) === "horizontal" ? af : nf), mergeProps(T.$attrs, {
            ...
            onStepKeyDown: M[6] || (M[6] = (V2, A2) => {
              if (!unref(d)) {
                const W2 = unref(As).includes(V2.key) || V2.shiftKey && unref(Os).includes(V2.key) ? 10 : 1, ee = C.value, N2 = unref(m2)[ee], G2 = unref(r) * W2 * A2;
    ...
    return t;
  {
    ...
    if (s[c] = v2, !Ve(v2, f)) {
      ...
      for (; C >= 0 && C < e.length; ) {
        ...
        if (Ve(_, h2) || (g -= h2 - _, s[C] = h2), Ve(g, 0))
          break;
        a2 > 0 ? C-- : C++;
      }
    }
...
var eg = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    watch(() => C.value.panelDataArrayChanged, () => {
...
var tg = defineComponent({
  ...
  setup(a2, { expose: t, emit: e }) {
    ...
    const { collapsePanel: r, expandPanel: i, getPanelSize: u, getPanelStyle: d, isPanelCollapsed: c, resizePanel: p, groupId: f, reevaluatePanelConstraints: v2, registerPanel: g, unregisterPanel: m2 } = s, C = he(n.id, "radix-vue-splitter-panel"), _ = computed(() => ({
      callbacks: {
...
var ag = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    } = i, g = he(e.id, "radix-vue-splitter-resize-handle"), m2 = ref("inactive"), C = ref(false), _ = ref(null);
    return watch(r, () => {
      ...
      onBlur: h2[0] || (h2[0] = (E) => C.value = false),
      onFocus: h2[1] || (h2[1] = (E) => C.value = false)
    }, {
      default: withCtx(() => [
        renderSlot(D.$slots, "default")
      ]),
...
var ng = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    const m2 = ref(null), C = ref(null), _ = computed(() => m2.value ? m2.value.getAttribute("disabled") === "" : true), D = computed(() => C.value ? C.value.getAttribute("disabled") === "" : true);
...
var yg = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, { addOnPaste: l, disabled: s, delimiter: r, max: i, id: u, dir: d, addOnBlur: c, addOnTab: p } = toRefs(e), f = be(d), v2 = ne(e, "modelValue", n, {
      ...
      passive: true,
      deep: true
    }), { forwardRef: g, currentElement: m2 } = R2(), { focused: C } = gi(m2), _ = Je(m2), { getItems: D } = ba(), h2 = ref(), E = ref(false);
    return Ff({
      modelValue: v2,
      onAddValue: (P2) => {
...
var bg = defineComponent({
  ...
  setup(a2) {
    const t = a2, { value: e } = toRefs(t), n = fn(), { forwardRef: l, currentElement: s } = R2(), r = computed(() => n.selectedElement.value === s.value), i = computed(() => t.disabled || n.disabled.value), u = Nf({
      value: e,
      isSelected: r,
      disabled: i,
      textId: "",
...
var Yf = defineComponent({
  ...
  setup(a2, { emit: t }) {
    ...
    const _ = computed(() => s.value ? sr(s.value) : null);
    ...
    return watchEffect((D) => {
      ...
      r.onToastRemove();
    }), qf({ onClose: C }), (D, h2) => (openBlock(), createElementBlock(Fragment, null, [
      _.value ? (openBlock(), createBlock(Uf, {
        key: 0,
        role: "status",
      ...
      unref(r).viewport.value ? (openBlock(), createBlock(Teleport, {
        ...
        createVNode(unref(O), mergeProps({
          ...
          onPointermove: h2[1] || (h2[1] = (E) => {
            ...
            T ? (u.value = W2, unref(Aa)(unref(Kf), (N2) => n("swipeMove", N2), ee)) : unref(nl)(W2, unref(r).swipeDirection.value, U) ? (u.value = W2, unref(Aa)(unref(zf), (N2) => n("swipeStart", N2), ee), E.target.setPointerCapture(E.pointerId)) : (Math.abs(P2) > U || Math.abs(B) > U) && (i.value = null);
          }),
  ...
  setup(a2) {
    ...
    jn(e.value, () => {
      ...
      if (d.value && m2) {
        ...
        m2.addEventListener("focusin", C), m2.addEventListener("focusout", D), m2.addEventListener("pointermove", C), m2.addEventListener("pointerleave", h2), m2.addEventListener("keydown", E), window.addEventListener("blur", C), window.addEventListener("focus", _), g(() => {
          m2.removeEventListener("focusin", C), m2.removeEventListener("focusout", D), m2.removeEventListener("pointermove", C), m2.removeEventListener("pointerleave", h2), m2.removeEventListener("keydown", E), window.removeEventListener("blur", C), window.removeEventListener("focus", _);
        });
      }
    });
...
var ev = defineComponent({
  ...
  emits: ["update:modelValue"],
  setup(a2, { emit: t }) {
    const e = a2, n = t, { loop: l, rovingFocus: s, disabled: r, dir: i } = toRefs(e), u = be(i), { forwardRef: d } = R2(), { modelValue: c, changeModelValue: p, isSingle: f } = Nl(e, n);
    return Qf({
      isSingle: f,
      modelValue: c,
      changeModelValue: p,
...
var Mg = defineComponent({
  ...
  setup(a2) {
    ...
    return (C, _) => (openBlock(), createBlock(unref(Rt), { "as-child": "" }, {
      default: withCtx(() => [
        createVNode(unref(O), mergeProps({
          ref: unref(l),
...
var Lg = defineComponent({
  ...
  setup(a2, { emit: t }) {
    const e = a2, n = t, { items: l, multiple: s, disabled: r, propagateSelect: i, dir: u } = toRefs(e), { handleTypeaheadSearch: d } = ga(), c = be(u), p = ref(), f = ref(false), v2 = ia(), g = ne(e, "modelValue", n, {
      ...
      deep: true
    }), { onSelectItem: C, handleMultipleReplace: _ } = Fi(g, e), D = computed(() => s.value && Array.isArray(g.value) ? g.value.map((T) => e.getKey(T)) : [e.getKey(g.value ?? {})]);
    function h2(T, M = 1, V2) {
      return T.reduce((A2, F, U) => {
        ...
        return A2.push(G2), ee && N2 && A2.push(...h2(ee, M + 1, F)), A2;
      }, []);
    }
    const E = computed(() => {
      const T = e.items;
  ...
  setup(a2) {
    ...
    return n.virtualKeydownHook.on((f) => {
      ...
      if (["first", "last"].includes(m2)) {
        ...
        const _ = document.activeElement, D = Number(_.getAttribute("data-index")), h2 = Number(_.getAttribute("data-indent")), P2 = n.expandedItems.value.slice(0, D).map((B, T) => ({ ...B, index: T })).reverse().find((B) => B.level === h2 - 1);
        P2 && p(P2.index);
      } else if (!m2 && !v2) {
        r.value += f.key;
        const _ = Number((C = document.activeElement) == null ? void 0 : C.getAttribute("data-index")), D = i.value[_].textContent, h2 = i.value.map((B) => B.textContent), E = Yn(h2, r.value, D), P2 = i.value.find((B) => B.textContent === E);
        P2 && p(P2.index);
      }
      nextTick(() => {
