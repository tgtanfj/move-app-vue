...
const isLoadingDateData = ref(false)
...
const selectCountry = async (countryId, country_name, total_users) => {
  if (country_name === 'Unknown') return
...
<template>
  <div class="mt-[56px] pt-4 pl-6 pr-20 w-full">
    ...
    <div v-if="isLoadingDateData" class="flex items-center justify-center h-96 w-full">
      <LoadingTable />
    </div>
    ...
    <div v-else>
      <div class="flex gap-14 mt-2" v-if="videoInDepth && videoInDepthGraphic">
        ...
        <div class="flex-[0.5]">
          <img
            :src="videoInDepth.thumbnail"
            alt="thumbnail"
            class="w-full object-cover h-[160px]"
          />
