...
When calling an API that requires authentication:

- **Attach the access token** to the `Authorization` header in the format: `Bearer <accessToken>`.

When the access token expires:

- **Send a GET request** to the `/auth/refresh` endpoint.
